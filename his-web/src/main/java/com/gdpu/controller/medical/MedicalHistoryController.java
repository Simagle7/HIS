package com.gdpu.controller.medical;
...
import com.gdpu.his.service.medical.IMedicalHistoryService;
...
public class MedicalHistoryController {
    ...
    public ModelAndView queryPage(MedicalHistoryParam param, @RequestParam(defaultValue = "1") int pageNo, @RequestParam(defaultValue = "10") int pageSize) {
        return medicalHistoryService.queryPage(param, pageNo, pageSize);
    }
